...
/**
 * Creates a Java Swing GUI that has a grid of images that represent the communication
 * device of the AAC.
 * 
 * This program does not need to be modified - except if you want to test - comment out one of the lines 56 and 57.
 * 
